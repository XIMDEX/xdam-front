...
export const {
  ...
  REACT_APP_PUBLIC_WORKSPACE_ID,
  REACT_APP_API_XEVAL:API_XEVAL_URL
} = process.env
...
export const SHOW_THEMES_BOOK = process.env.REACT_APP_SHOW_THEMES_BOOK ?? false
...
export const WORKSPACE_PUBLIC_ID =  parseInt(REACT_APP_PUBLIC_WORKSPACE_ID) ?? parseInt("25")
