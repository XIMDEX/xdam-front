...
describe('Clone Test', function() {
  ...
  it('Create Activity 3', async function() {
    ...
    // 18 | type | id=root_description_name | test 3   //label[contains(.,\'name *\')]/following-sibling::input
  ...
  it('Create Activity - Last Resource created', async function() {
    // Test name: Create Activity - Last Resource created
    // Step # | name | target | value
    // 1 | open | http://192.168.0.30:3000/home | 
    await driver.get(confmap.url)
    // 2 | setWindowSize | 1920x1080 | 
    ...
    // 9 | assertElementNotPresent | css=li | 
    {
      const elements = await driver.findElements(By.css("li"))
      assert(!elements.length)
    }
    // 10 | waitForElementPresent | css=input:nth-child(2) | 30000
    await driver.wait(until.elementLocated(By.css("input:nth-child(2)")), 30000)
    ...
    // 12 | click | css=.label > .divider | 
    await driver.findElement(By.css(".label > .divider")).click()
    // 13 | pause | 250 | 250
    await driver.sleep(250)
    // 14 | waitForElementPresent | css=.visible > .item:nth-child(1) > .text | 30000
    await driver.wait(until.elementLocated(By.css(".visible > .item:nth-child(1) > .text")), 30000)
    // 15 | waitForElementVisible | css=.visible > .item:nth-child(1) > .text | 30000
    await driver.wait(until.elementIsVisible(await driver.findElement(By.css(".visible > .item:nth-child(1) > .text"))), 30000)
    // 16 | assertText | css=.visible > .item:nth-child(1) > .text | Public Organization Activity collection
    assert(await driver.findElement(By.css(".visible > .item:nth-child(1) > .text")).getText() == "Public Organization Activity collection")
    // 17 | click | css=.visible > .item:nth-child(1) > .text | 
    await driver.findElement(By.css(".visible > .item:nth-child(1) > .text")).click()
    // 18 | waitForElementPresent | css=.teal > .ui:nth-child(1) | 30000
    await driver.wait(until.elementLocated(By.css(".teal > .ui:nth-child(1)")), 30000)
    // 19 | assertText | css=.teal > .ui:nth-child(1) | New activity
    assert(await driver.findElement(By.css(".teal > .ui:nth-child(1)")).getText() == "New activity")
    // 20 | click | css=.teal > .ui:nth-child(1) | New activity
    await driver.findElement(By.css(".teal > .ui:nth-child(1)")).click()
    // 21 | pause | 250 | 250
    await driver.sleep(250)
    // 22 | click | css=.labeled:nth-child(2) | 
    await driver.findElement(By.css(".labeled:nth-child(2)")).click()
    // 23 | click | css=.visible > .item:nth-child(1) | 
    await driver.findElement(By.css(".visible > .item:nth-child(1)")).click()
    // 24 | pause | 500 | 500
    await driver.sleep(500)
    // 25 | verifyValue | id=root_description_name | test 3
    {
      const value = await driver.findElement(By.xpath("//label[contains(.,\'name *\')]/following-sibling::input")).getAttribute("value")
      assert(value == "test 3")
    }
    // 26 | verifyValue | id=root_description_external_url | www.test3.com
    {
      const value = await driver.findElement(By.xpath("//label[contains(.,\'external_url\')]/following-sibling::input")).getAttribute("value")
      assert(value == "www.test3.com")
    }
    // 27 | verifyValue | id=root_description_description | test description 3
    {
      const value = await driver.findElement(By.xpath("//label[contains(.,\'description\')]/following-sibling::textarea")).getAttribute("value")
      assert(value == "test description 3")
    }
    // 28 | verifyText | css=.grouped:nth-child(6) .forms-textField > .ui | test 2
    assert(await driver.findElement(By.css(".grouped:nth-child(6) .forms-textField > .ui")).getText() == "test 2")
    // 29 | verifyText | css=.grouped:nth-child(7) .forms-textField > .ui | test 1
    assert(await driver.findElement(By.css(".grouped:nth-child(7) .forms-textField > .ui")).getText() == "test 1")
    // 30 | pause | 800 | 800
    ...
    // 32 | pause | 800 | 800
    await driver.sleep(800)
    // 33 | verifyText | xpath=//p[contains(.,'Resource created')] | Resource created
    assert(await driver.findElement(By.xpath("//p[contains(.,\'Resource created\')]")).getText() == "Resource created")
    // 34 | click | css=.circular > .close | 
    await driver.findElement(By.css(".circular > .close")).click()
  })
  ...
  it('Edit Activity 1-10', async function() {
    ...
    await driver.findElement(By.xpath("//label[contains(.,\'name *\')]/following-sibling::input")).sendKeys(Key.CONTROL + "a")
    await driver.findElement(By.xpath("//label[contains(.,\'name *\')]/following-sibling::input")).sendKeys(Key.DELETE)
    ...
    await driver.findElement(By.xpath("//label[contains(.,\'description\')]/following-sibling::textarea")).sendKeys(Key.CONTROL + "a")
    await driver.findElement(By.xpath("//label[contains(.,\'description\')]/following-sibling::textarea")).sendKeys(Key.DELETE)
  ...
  it('Check Activity Edited 1', async function() {
    // Test name: Check Activity Edited 1
    // Step # | name | target | value
    // 1 | open | http://192.168.0.30:3000/home | 
    await driver.get(confmap.url)
    // 2 | setWindowSize | 1920x1080 | 
    ...
    // 20 | pause | 250 | 250
    await driver.sleep(250)
    // 21 | click | css=.MuiGrid-root:nth-child(1) > .dam-item .sc-dlnjwi |  
    await driver.findElement(By.css(".MuiGrid-root:nth-child(1) > .dam-item .sc-dlnjwi")).click()
    // 22 | waitForElementPresent | css=.MuiTypography-h6 | 5000
    await driver.wait(until.elementLocated(By.css(".MuiTypography-h6")), 5000)
    // 23 | pause | 250 | 250
    await driver.sleep(250)
    // 24 | waitForElementVisible | css=.MuiTypography-h6 | 5000
    await driver.wait(until.elementIsVisible(await driver.findElement(By.css(".MuiTypography-h6"))), 5000)
    // 25 | assertText | css=.MuiTypography-h6 | Test 1 Edited
    assert(await driver.findElement(By.css(".MuiTypography-h6")).getText() == "Test 1 Edited")
    // 26 | click | css=.close | 
    await driver.findElement(By.css(".close")).click()
    // 27 | click | css=.MuiGrid-root:nth-child(1) > .dam-item .edit | 
    await driver.findElement(By.css(".MuiGrid-root:nth-child(1) > .dam-item .edit")).click()
    // 28 | waitForElementPresent | id=root_description_external_url | 5000
    await driver.wait(until.elementLocated(By.xpath("//label[contains(.,\'external_url\')]/following-sibling::input")), 5000)
    // 29 | pause | 250 | 250
    await driver.sleep(250)
    // 30 | verifyValue | id=root_description_external_url | www.test1.com
    {
      const value = await driver.findElement(By.xpath("//label[contains(.,\'external_url\')]/following-sibling::input")).getAttribute("value")
      assert(value == "www.test1.com")
    }
    // 31 | verifyValue | id=root_description_name | test 1 edited
    {
      const value = await driver.findElement(By.xpath("//label[contains(.,\'name *\')]/following-sibling::input")).getAttribute("value")
    ...
    // 35 | click | linkText=LOM-ES | 
    await driver.findElement(By.linkText("LOM-ES")).click()
    // 36 | waitForElementPresent | id=rjsf_prefix | 5000
    await driver.wait(until.elementLocated(By.id("rjsf_prefix")), 5000)
    // 37 | pause | 250 | 250
    await driver.sleep(250)
    // 38 | verifyValue | id=rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.id("rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 39 | verifyValue | css=.grouped:nth-child(3) #rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.css(".grouped:nth-child(3) #rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 40 | verifyValue | css=.grouped:nth-child(4) #rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.css(".grouped:nth-child(4) #rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 41 | verifyValue | css=.grouped:nth-child(5) #rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.css(".grouped:nth-child(5) #rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 42 | verifyText | xpath=//form/div/div[5]/div | es
    assert(await driver.findElement(By.xpath("//form/div/div[5]/div")).getText() == "es")
    // 43 | verifyValue | css=.grouped:nth-child(7) #rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.css(".grouped:nth-child(7) #rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 44 | verifyValue | css=.grouped:nth-child(8) #rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.css(".grouped:nth-child(8) #rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 45 | verifyValue | css=.grouped:nth-child(9) #rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.css(".grouped:nth-child(9) #rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 46 | verifyValue | css=.grouped:nth-child(10) #rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.css(".grouped:nth-child(10) #rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 47 | verifyValue | css=.grouped:nth-child(11) #rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.css(".grouped:nth-child(11) #rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 48 | click | css=#vertical-tab-2 > .MuiTab-wrapper | 
    await driver.findElement(By.css("#vertical-tab-2 > .MuiTab-wrapper")).click()
    // 49 | waitForElementPresent | id=rjsf_prefix | 5000
    await driver.wait(until.elementLocated(By.id("rjsf_prefix")), 5000)
    // 50 | pause | 250 | 250
    await driver.sleep(250)
    // 51 | verifyValue | id=rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.id("rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 52 | verifyValue | css=.grouped:nth-child(3) #rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.css(".grouped:nth-child(3) #rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 53 | verifyValue | css=.grouped:nth-child(4) #rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.css(".grouped:nth-child(4) #rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 54 | verifyValue | css=.grouped:nth-child(5) #rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.css(".grouped:nth-child(5) #rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 55 | verifyValue | css=.grouped:nth-child(6) #rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.css(".grouped:nth-child(6) #rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 56 | verifyValue | css=.grouped:nth-child(7) #rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.css(".grouped:nth-child(7) #rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 57 | click | css=#vertical-tab-3 > .MuiTab-wrapper | 
    await driver.findElement(By.css("#vertical-tab-3 > .MuiTab-wrapper")).click()
    // 58 | waitForElementPresent | id=rjsf_prefix | 5000
    await driver.wait(until.elementLocated(By.id("rjsf_prefix")), 5000)
    // 59 | pause | 250 | 250
    await driver.sleep(250)
    // 60 | verifyValue | id=rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.id("rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 61 | verifyValue | css=.grouped:nth-child(3) #rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.css(".grouped:nth-child(3) #rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 62 | verifyValue | css=.grouped:nth-child(4) #rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.css(".grouped:nth-child(4) #rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 63 | verifyValue | css=.grouped:nth-child(5) #rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.css(".grouped:nth-child(5) #rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 64 | verifyValue | css=.grouped:nth-child(6) #rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.css(".grouped:nth-child(6) #rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 65 | verifyValue | css=.grouped:nth-child(7) #rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.css(".grouped:nth-child(7) #rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 66 | verifyValue | css=.grouped:nth-child(8) #rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.css(".grouped:nth-child(8) #rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 68 | verifyValue | css=.grouped:nth-child(9) #rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.css(".grouped:nth-child(9) #rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 69 | click | css=.selection:nth-child(2) | 
    await driver.findElement(By.css(".selection:nth-child(2)")).click()
    // 70 | click | css=.visible > .selected | 
    await driver.findElement(By.css(".visible > .selected")).click()
    // 71 | click | css=.ui > div > .button | 
    await driver.findElement(By.css(".ui > div > .button")).click()
    // 72 | click | css=#vertical-tab-4 > .MuiTab-wrapper | 
    await driver.findElement(By.css("#vertical-tab-4 > .MuiTab-wrapper")).click()
    // 73 | waitForElementPresent | id=rjsf_prefix | 5000
    await driver.wait(until.elementLocated(By.id("rjsf_prefix")), 5000)
    // 74 | pause | 250 | 250
    await driver.sleep(250)
    // 75 | verifyValue | id=rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.id("rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 76 | verifyValue | css=.grouped:nth-child(3) #rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.css(".grouped:nth-child(3) #rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 77 | verifyValue | css=.grouped:nth-child(4) #rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.css(".grouped:nth-child(4) #rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 78 | verifyValue | css=.grouped:nth-child(5) #rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.css(".grouped:nth-child(5) #rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 79 | verifyValue | css=.grouped:nth-child(6) #rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.css(".grouped:nth-child(6) #rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 80 | verifyValue | css=.grouped:nth-child(7) #rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.css(".grouped:nth-child(7) #rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 81 | verifyValue | css=.grouped:nth-child(8) #rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.css(".grouped:nth-child(8) #rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 83 | verifyValue | css=.grouped:nth-child(9) #rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.css(".grouped:nth-child(9) #rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 84 | verifyValue | css=.grouped:nth-child(10) #rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.css(".grouped:nth-child(10) #rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 85 | verifyValue | css=.grouped:nth-child(11) #rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.css(".grouped:nth-child(11) #rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 86 | verifyValue | css=.grouped:nth-child(12) #rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.css(".grouped:nth-child(12) #rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 87 | verifyValue | css=.grouped:nth-child(13) #rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.css(".grouped:nth-child(13) #rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 88 | click | css=#vertical-tab-5 > .MuiTab-wrapper | 
    await driver.findElement(By.css("#vertical-tab-5 > .MuiTab-wrapper")).click()
    // 89 | waitForElementPresent | css=.grouped:nth-child(2) > .ui | 5000
    await driver.wait(until.elementLocated(By.css(".grouped:nth-child(2) > .ui")), 5000)
    // 90 | pause | 250 | 250
    await driver.sleep(250)
    // 91 | verifyText | css=.grouped:nth-child(2) > .ui | activo
    assert(await driver.findElement(By.css(".grouped:nth-child(2) > .ui")).getText() == "activo")
    // 92 | verifyText | css=.grouped:nth-child(3) > .ui | no values set
    assert(await driver.findElement(By.css(".grouped:nth-child(3) > .ui")).getText() == "no values set")
    // 93 | verifyText | css=.grouped:nth-child(4) > .ui | muy bajo
    assert(await driver.findElement(By.css(".grouped:nth-child(4) > .ui")).getText() == "muy bajo")
    // 94 | verifyValue | id=rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.id("rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 95 | verifyText | css=.grouped:nth-child(6) > .ui | no values set
    assert(await driver.findElement(By.css(".grouped:nth-child(6) > .ui")).getText() == "no values set")
    // 96 | verifyText | css=.grouped:nth-child(7) > .ui | no values set
    assert(await driver.findElement(By.css(".grouped:nth-child(7) > .ui")).getText() == "no values set")
    // 97 | verifyValue | css=.grouped:nth-child(8) #rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.css(".grouped:nth-child(8) #rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 98 | verifyText | css=.grouped:nth-child(9) > .ui | muy difícil
    assert(await driver.findElement(By.css(".grouped:nth-child(9) > .ui")).getText() == "muy difícil")
    // 99 | verifyValue | css=.grouped:nth-child(10) #rjsf_prefix | 5
    {
      const value = await driver.findElement(By.css(".grouped:nth-child(10) #rjsf_prefix")).getAttribute("value")
      assert(value == "5")
    }
    // 100 | verifyValue | css=.grouped:nth-child(11) #rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.css(".grouped:nth-child(11) #rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 101 | verifyText | css=.grouped:nth-child(12) > .ui | es
    assert(await driver.findElement(By.css(".grouped:nth-child(12) > .ui")).getText() == "es")
    // 102 | verifyText | css=.grouped:nth-child(13) > .ui | no values set
    assert(await driver.findElement(By.css(".grouped:nth-child(13) > .ui")).getText() == "no values set")
    // 103 | click | css=#vertical-tab-6 > .MuiTab-wrapper | 
    await driver.findElement(By.css("#vertical-tab-6 > .MuiTab-wrapper")).click()
    // 104 | waitForElementPresent | css=.grouped:nth-child(2) > .ui | 5000
    await driver.wait(until.elementLocated(By.css(".grouped:nth-child(2) > .ui")), 5000)
    // 105 | pause | 250 | 250
    await driver.sleep(250)
    // 106 | verifyText | css=.grouped:nth-child(2) > .ui | sí
    assert(await driver.findElement(By.css(".grouped:nth-child(2) > .ui")).getText() == "sí")
    // 107 | verifyText | css=.grouped:nth-child(3) > .ui | no values set
    assert(await driver.findElement(By.css(".grouped:nth-child(3) > .ui")).getText() == "no values set")
    // 108 | verifyValue | id=rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.id("rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 109 | verifyValue | css=.grouped:nth-child(5) #rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.css(".grouped:nth-child(5) #rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 110 | verifyValue | css=.grouped:nth-child(6) #rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.css(".grouped:nth-child(6) #rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 111 | click | css=#vertical-tab-7 > .MuiTab-wrapper | 
    await driver.findElement(By.css("#vertical-tab-7 > .MuiTab-wrapper")).click()
    // 112 | waitForElementPresent | id=rjsf_prefix | 5000
    await driver.wait(until.elementLocated(By.id("rjsf_prefix")), 5000)
    // 113 | pause | 250 | 250
    await driver.sleep(250)
    // 114 | verifyValue | id=rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.id("rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 115 | verifyValue | css=.grouped:nth-child(3) #rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.css(".grouped:nth-child(3) #rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 116 | verifyValue | css=.grouped:nth-child(4) #rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.css(".grouped:nth-child(4) #rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 117 | verifyValue | css=.grouped:nth-child(5) #rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.css(".grouped:nth-child(5) #rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 118 | verifyValue | css=.grouped:nth-child(6) #rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.css(".grouped:nth-child(6) #rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 119 | verifyValue | css=.grouped:nth-child(7) #rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.css(".grouped:nth-child(7) #rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 120 | click | css=#vertical-tab-8 > .MuiTab-wrapper | 
    await driver.findElement(By.css("#vertical-tab-8 > .MuiTab-wrapper")).click()
    // 121 | waitForElementPresent | id=rjsf_prefix | 5000
    await driver.wait(until.elementLocated(By.id("rjsf_prefix")), 5000)
    // 122 | pause | 250 | 250
    await driver.sleep(250)
    // 123 | verifyValue | id=rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.id("rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 124 | verifyValue | css=.grouped:nth-child(3) #rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.css(".grouped:nth-child(3) #rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 125 | verifyValue | css=.grouped:nth-child(4) #rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.css(".grouped:nth-child(4) #rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 126 | click | css=#vertical-tab-9 > .MuiTab-wrapper | 
    await driver.findElement(By.css("#vertical-tab-9 > .MuiTab-wrapper")).click()
    // 127 | waitForElementPresent | id=rjsf_prefix | 5000
    await driver.wait(until.elementLocated(By.id("rjsf_prefix")), 5000)
    // 128 | pause | 250 | 250
    await driver.sleep(250)
    // 129 | verifyValue | id=rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.id("rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 130 | verifyValue | css=.grouped:nth-child(3) #rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.css(".grouped:nth-child(3) #rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 131 | verifyValue | css=.grouped:nth-child(4) #rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.css(".grouped:nth-child(4) #rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 132 | verifyValue | css=.grouped:nth-child(5) #rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.css(".grouped:nth-child(5) #rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 133 | verifyValue | css=.grouped:nth-child(6) #rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.css(".grouped:nth-child(6) #rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 134 | verifyValue | css=.grouped:nth-child(7) #rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.css(".grouped:nth-child(7) #rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 135 | verifyValue | css=.grouped:nth-child(8) #rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.css(".grouped:nth-child(8) #rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 136 | verifyValue | css=.grouped:nth-child(9) #rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.css(".grouped:nth-child(9) #rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
  ...
  it('Create Activity - Last Resource updated', async function() {
    // Test name: Create Activity - Last Resource updated
    // Step # | name | target | value
    // 1 | open | http://192.168.0.30:3000/home | 
    await driver.get(confmap.url)
    // 2 | setWindowSize | 1920x1080 | 
    ...
    // 14 | pause | 250 | 250
    await driver.sleep(250)
    // 15 | click | css=.teal > .ui:nth-child(1) | 
    await driver.findElement(By.css(".teal > .ui:nth-child(1)")).click()
    // 16 | pause | 250 | 250
    await driver.sleep(250)
    // 17 | click | css=.labeled > .divider | 
    await driver.findElement(By.css(".labeled > .divider")).click()
    // 18 | click | css=.visible > .item:nth-child(2) | 
    await driver.findElement(By.css(".visible > .item:nth-child(2)")).click()
    // 19 | pause | 250 | 250
    await driver.sleep(250)
    // 20 | verifyValue | id=root_description_external_url | www.test1.com
    {
      const value = await driver.findElement(By.xpath("//label[contains(.,\'external_url\')]/following-sibling::input")).getAttribute("value")
      assert(value == "www.test1.com")
    }
    // 21 | verifyValue | id=root_description_name | test 1 edited
    {
      const value = await driver.findElement(By.xpath("//label[contains(.,\'name *\')]/following-sibling::input")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 22 | verifyValue | id=root_description_description | test description, test 1 edited
    {
      const value = await driver.findElement(By.xpath("//label[contains(.,\'description\')]/following-sibling::textarea")).getAttribute("value")
      assert(value == "test description, test 1 edited")
    }
    // 23 | verifyText | css=.grouped:nth-child(6) .forms-arrayItem:nth-child(2) > .forms-textField > .ui | edited
    assert(await driver.findElement(By.css(".grouped:nth-child(6) .forms-arrayItem:nth-child(2) > .forms-textField > .ui")).getText() == "edited")
    // 24 | verifyText | css=.grouped:nth-child(7) .forms-arrayItem:nth-child(2) > .forms-textField > .ui | edited
    assert(await driver.findElement(By.css(".grouped:nth-child(7) .forms-arrayItem:nth-child(2) > .forms-textField > .ui")).getText() == "edited")
    // 25 | click | css=.forms-main-btns > .ui:nth-child(1) | 
    await driver.findElement(By.css(".forms-main-btns > .ui:nth-child(1)")).click()
    // 26 | pause | 1500 | 1500
    await driver.sleep(1500)
    // 27 | waitForElementVisible | xpath=//p[contains(.,'Resource created')] | Resource created
    await driver.wait(until.elementIsVisible(await driver.findElement(By.xpath("//p[contains(.,\'Resource created\')]"))), NaN)
    // 28 | verifyText | xpath=//p[contains(.,'Resource created')] | Resource created
    assert(await driver.findElement(By.xpath("//p[contains(.,\'Resource created\')]")).getText() == "Resource created")
    // 29 | click | css=.close | 
    await driver.findElement(By.css(".close")).click()
    // 30 | waitForElementPresent | css=input:nth-child(2) | 30000
    await driver.wait(until.elementLocated(By.css("input:nth-child(2)")), 30000)
    // 31 | click | css=input:nth-child(2) | 
    await driver.findElement(By.css("input:nth-child(2)")).click()
    // 32 | type | css=input:nth-child(2) | test 1 edited
    await driver.findElement(By.css("input:nth-child(2)")).sendKeys("test 1 edited")
    // 33 | sendKeys | css=input:nth-child(2) | ${KEY_ENTER}
    await driver.findElement(By.css("input:nth-child(2)")).sendKeys(Key.ENTER)
    // 34 | waitForElementPresent | css=.MuiGrid-root:nth-child(1) > .dam-item | 5000
    await driver.wait(until.elementLocated(By.css(".MuiGrid-root:nth-child(1) > .dam-item")), 5000)
    // 35 | assertElementPresent | css=.MuiGrid-root:nth-child(1) > .dam-item | 
    {
      const elements = await driver.findElements(By.css(".MuiGrid-root:nth-child(1) > .dam-item"))
      assert(elements.length)
    }
    // 36 | pause | 250 | 250
    await driver.sleep(250)
    // 37 | click | css=.MuiGrid-root:nth-child(1) > .dam-item .sc-dlnjwi |  
    await driver.findElement(By.css(".MuiGrid-root:nth-child(1) > .dam-item .sc-dlnjwi")).click()
    // 38 | waitForElementPresent | css=.MuiTypography-h6 | 5000
    await driver.wait(until.elementLocated(By.css(".MuiTypography-h6")), 5000)
    // 39 | waitForElementVisible | css=.MuiTypography-h6 | 5000
    await driver.wait(until.elementIsVisible(await driver.findElement(By.css(".MuiTypography-h6"))), 5000)
    // 40 | pause | 250 | 250
    await driver.sleep(250)
    // 41 | assertText | css=.MuiTypography-h6 | Test 1 Edited
    assert(await driver.findElement(By.css(".MuiTypography-h6")).getText() == "Test 1 Edited")
    // 42 | click | css=.close | 
    await driver.findElement(By.css(".close")).click()
    // 43 | pause | 800 | 800
    await driver.sleep(800)
    // 44 | click | css=.MuiGrid-root:nth-child(1) > .dam-item .edit | 
    await driver.findElement(By.css(".MuiGrid-root:nth-child(1) > .dam-item .edit")).click()
    // 45 | pause | 800 | 800
    await driver.sleep(800)
    // 46 | click | linkText=LOM-ES | 
    await driver.findElement(By.linkText("LOM-ES")).click()
    // 47 | waitForElementPresent | id=rjsf_prefix | 5000
    await driver.wait(until.elementLocated(By.id("rjsf_prefix")), 5000)
    // 48 | pause | 250 | 250
    await driver.sleep(250)
    // 49 | verifyValue | id=rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.id("rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 50 | verifyValue | css=.grouped:nth-child(3) #rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.css(".grouped:nth-child(3) #rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 51 | verifyValue | css=.grouped:nth-child(4) #rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.css(".grouped:nth-child(4) #rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 52 | verifyValue | css=.grouped:nth-child(5) #rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.css(".grouped:nth-child(5) #rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 53 | verifyText | xpath=//form/div/div[5]/div | es
    assert(await driver.findElement(By.xpath("//form/div/div[5]/div")).getText() == "es")
    // 54 | verifyValue | css=.grouped:nth-child(7) #rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.css(".grouped:nth-child(7) #rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 55 | verifyValue | css=.grouped:nth-child(8) #rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.css(".grouped:nth-child(8) #rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 56 | verifyValue | css=.grouped:nth-child(9) #rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.css(".grouped:nth-child(9) #rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 57 | verifyValue | css=.grouped:nth-child(10) #rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.css(".grouped:nth-child(10) #rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 58 | verifyValue | css=.grouped:nth-child(11) #rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.css(".grouped:nth-child(11) #rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 59 | click | css=#vertical-tab-2 > .MuiTab-wrapper | 
    await driver.findElement(By.css("#vertical-tab-2 > .MuiTab-wrapper")).click()
    // 60 | waitForElementPresent | id=rjsf_prefix | 5000
    await driver.wait(until.elementLocated(By.id("rjsf_prefix")), 5000)
    // 61 | pause | 250 | 250
    await driver.sleep(250)
    // 62 | verifyValue | id=rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.id("rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 63 | verifyValue | css=.grouped:nth-child(3) #rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.css(".grouped:nth-child(3) #rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 64 | verifyValue | css=.grouped:nth-child(4) #rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.css(".grouped:nth-child(4) #rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 65 | verifyValue | css=.grouped:nth-child(5) #rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.css(".grouped:nth-child(5) #rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 66 | verifyValue | css=.grouped:nth-child(6) #rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.css(".grouped:nth-child(6) #rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 67 | verifyValue | css=.grouped:nth-child(7) #rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.css(".grouped:nth-child(7) #rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 68 | click | css=#vertical-tab-3 > .MuiTab-wrapper | 
    await driver.findElement(By.css("#vertical-tab-3 > .MuiTab-wrapper")).click()
    // 69 | waitForElementPresent | id=rjsf_prefix | 5000
    await driver.wait(until.elementLocated(By.id("rjsf_prefix")), 5000)
    // 70 | pause | 250 | 250
    await driver.sleep(250)
    // 71 | verifyValue | id=rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.id("rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 72 | verifyValue | css=.grouped:nth-child(3) #rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.css(".grouped:nth-child(3) #rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 73 | verifyValue | css=.grouped:nth-child(4) #rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.css(".grouped:nth-child(4) #rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 74 | verifyValue | css=.grouped:nth-child(5) #rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.css(".grouped:nth-child(5) #rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 75 | verifyValue | css=.grouped:nth-child(6) #rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.css(".grouped:nth-child(6) #rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 76 | verifyValue | css=.grouped:nth-child(7) #rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.css(".grouped:nth-child(7) #rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 77 | verifyValue | css=.grouped:nth-child(8) #rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.css(".grouped:nth-child(8) #rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 79 | verifyValue | css=.grouped:nth-child(9) #rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.css(".grouped:nth-child(9) #rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 80 | click | css=.selection:nth-child(2) | 
    await driver.findElement(By.css(".selection:nth-child(2)")).click()
    // 81 | click | css=.visible > .selected | 
    await driver.findElement(By.css(".visible > .selected")).click()
    // 82 | click | css=.ui > div > .button | 
    await driver.findElement(By.css(".ui > div > .button")).click()
    // 83 | click | css=#vertical-tab-4 > .MuiTab-wrapper | 
    await driver.findElement(By.css("#vertical-tab-4 > .MuiTab-wrapper")).click()
    // 84 | waitForElementPresent | id=rjsf_prefix | 5000
    await driver.wait(until.elementLocated(By.id("rjsf_prefix")), 5000)
    // 85 | pause | 250 | 250
    await driver.sleep(250)
    // 86 | verifyValue | id=rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.id("rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 87 | verifyValue | css=.grouped:nth-child(3) #rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.css(".grouped:nth-child(3) #rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 88 | verifyValue | css=.grouped:nth-child(4) #rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.css(".grouped:nth-child(4) #rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 89 | verifyValue | css=.grouped:nth-child(5) #rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.css(".grouped:nth-child(5) #rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 90 | verifyValue | css=.grouped:nth-child(6) #rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.css(".grouped:nth-child(6) #rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 91 | verifyValue | css=.grouped:nth-child(7) #rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.css(".grouped:nth-child(7) #rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 92 | verifyValue | css=.grouped:nth-child(8) #rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.css(".grouped:nth-child(8) #rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 94 | verifyValue | css=.grouped:nth-child(9) #rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.css(".grouped:nth-child(9) #rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 95 | verifyValue | css=.grouped:nth-child(10) #rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.css(".grouped:nth-child(10) #rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 96 | verifyValue | css=.grouped:nth-child(11) #rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.css(".grouped:nth-child(11) #rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 97 | verifyValue | css=.grouped:nth-child(12) #rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.css(".grouped:nth-child(12) #rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 98 | verifyValue | css=.grouped:nth-child(13) #rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.css(".grouped:nth-child(13) #rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 99 | click | css=#vertical-tab-5 > .MuiTab-wrapper | 
    await driver.findElement(By.css("#vertical-tab-5 > .MuiTab-wrapper")).click()
    // 100 | waitForElementPresent | css=.grouped:nth-child(2) > .ui | 5000
    await driver.wait(until.elementLocated(By.css(".grouped:nth-child(2) > .ui")), 5000)
    // 101 | pause | 250 | 250
    await driver.sleep(250)
    // 102 | verifyText | css=.grouped:nth-child(2) > .ui | activo
    assert(await driver.findElement(By.css(".grouped:nth-child(2) > .ui")).getText() == "activo")
    // 103 | verifyText | css=.grouped:nth-child(3) > .ui | no values set
    assert(await driver.findElement(By.css(".grouped:nth-child(3) > .ui")).getText() == "no values set")
    // 104 | verifyText | css=.grouped:nth-child(4) > .ui | muy bajo
    assert(await driver.findElement(By.css(".grouped:nth-child(4) > .ui")).getText() == "muy bajo")
    // 105 | verifyValue | id=rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.id("rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 106 | verifyText | css=.grouped:nth-child(6) > .ui | no values set
    assert(await driver.findElement(By.css(".grouped:nth-child(6) > .ui")).getText() == "no values set")
    // 107 | verifyText | css=.grouped:nth-child(7) > .ui | no values set
    assert(await driver.findElement(By.css(".grouped:nth-child(7) > .ui")).getText() == "no values set")
    // 108 | verifyValue | css=.grouped:nth-child(8) #rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.css(".grouped:nth-child(8) #rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 109 | verifyText | css=.grouped:nth-child(9) > .ui | muy difícil
    assert(await driver.findElement(By.css(".grouped:nth-child(9) > .ui")).getText() == "muy difícil")
    // 110 | verifyValue | css=.grouped:nth-child(10) #rjsf_prefix | 5
    {
      const value = await driver.findElement(By.css(".grouped:nth-child(10) #rjsf_prefix")).getAttribute("value")
      assert(value == "5")
    }
    // 111 | verifyValue | css=.grouped:nth-child(11) #rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.css(".grouped:nth-child(11) #rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 112 | verifyText | css=.grouped:nth-child(12) > .ui | es
    assert(await driver.findElement(By.css(".grouped:nth-child(12) > .ui")).getText() == "es")
    // 113 | verifyText | css=.grouped:nth-child(13) > .ui | no values set
    assert(await driver.findElement(By.css(".grouped:nth-child(13) > .ui")).getText() == "no values set")
    // 114 | click | css=#vertical-tab-6 > .MuiTab-wrapper | 
    await driver.findElement(By.css("#vertical-tab-6 > .MuiTab-wrapper")).click()
    // 115 | waitForElementPresent | css=.grouped:nth-child(2) > .ui | 5000
    await driver.wait(until.elementLocated(By.css(".grouped:nth-child(2) > .ui")), 5000)
    // 116 | pause | 250 | 250
    await driver.sleep(250)
    // 117 | verifyText | css=.grouped:nth-child(2) > .ui | sí
    assert(await driver.findElement(By.css(".grouped:nth-child(2) > .ui")).getText() == "sí")
    // 118 | verifyText | css=.grouped:nth-child(3) > .ui | no values set
    assert(await driver.findElement(By.css(".grouped:nth-child(3) > .ui")).getText() == "no values set")
    ...
    // 120 | verifyValue | css=.grouped:nth-child(5) #rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.css(".grouped:nth-child(5) #rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 121 | verifyValue | css=.grouped:nth-child(6) #rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.css(".grouped:nth-child(6) #rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 122 | click | css=#vertical-tab-7 > .MuiTab-wrapper | 
    await driver.findElement(By.css("#vertical-tab-7 > .MuiTab-wrapper")).click()
    // 123 | waitForElementPresent | id=rjsf_prefix | 5000
    await driver.wait(until.elementLocated(By.id("rjsf_prefix")), 5000)
    // 124 | pause | 250 | 250
    await driver.sleep(250)
    // 125 | verifyValue | id=rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.id("rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 126 | verifyValue | css=.grouped:nth-child(3) #rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.css(".grouped:nth-child(3) #rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 127 | verifyValue | css=.grouped:nth-child(4) #rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.css(".grouped:nth-child(4) #rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 128 | verifyValue | css=.grouped:nth-child(5) #rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.css(".grouped:nth-child(5) #rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 129 | verifyValue | css=.grouped:nth-child(6) #rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.css(".grouped:nth-child(6) #rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 130 | verifyValue | css=.grouped:nth-child(7) #rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.css(".grouped:nth-child(7) #rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 131 | click | css=#vertical-tab-8 > .MuiTab-wrapper | 
    await driver.findElement(By.css("#vertical-tab-8 > .MuiTab-wrapper")).click()
    ...
    // 137 | click | css=#vertical-tab-9 > .MuiTab-wrapper | 
    await driver.findElement(By.css("#vertical-tab-9 > .MuiTab-wrapper")).click()
    // 138 | waitForElementPresent | id=rjsf_prefix | 5000
    await driver.wait(until.elementLocated(By.id("rjsf_prefix")), 5000)
    // 139 | pause | 250 | 250
    await driver.sleep(250)
    // 140 | verifyValue | id=rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.id("rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 141 | verifyValue | css=.grouped:nth-child(3) #rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.css(".grouped:nth-child(3) #rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 142 | verifyValue | css=.grouped:nth-child(4) #rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.css(".grouped:nth-child(4) #rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 143 | verifyValue | css=.grouped:nth-child(5) #rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.css(".grouped:nth-child(5) #rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 144 | verifyValue | css=.grouped:nth-child(6) #rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.css(".grouped:nth-child(6) #rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 145 | verifyValue | css=.grouped:nth-child(7) #rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.css(".grouped:nth-child(7) #rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 146 | verifyValue | css=.grouped:nth-child(8) #rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.css(".grouped:nth-child(8) #rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 147 | verifyValue | css=.grouped:nth-child(9) #rjsf_prefix | test 1 edited
    {
      const value = await driver.findElement(By.css(".grouped:nth-child(9) #rjsf_prefix")).getAttribute("value")
      assert(value == "test 1 edited")
    }
    // 148 | click | linkText=Main Data | 
    await driver.findElement(By.linkText("Main Data")).click()
    // 149 | click | css=.forms-main-btns > .ui:nth-child(1) | 
    await driver.findElement(By.css(".forms-main-btns > .ui:nth-child(1)")).click()
    // 150 | click | css=.close | 
    await driver.findElement(By.css(".close")).click()
  })
  it('Delete Activity', async function() {
    ...
    // 60 | pause | 1500 | 1500
    await driver.sleep(1500)
    console.log("antes de recoger la variable");
    ...
    console.log("despues de recoger la variable");
    // 62 | if | ${exist3} > 0 | 
